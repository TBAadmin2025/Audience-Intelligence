...
import { ShieldCheck, Lock, Activity, TriangleAlert, TrendingUp, CheckCircle2, Sparkles, ArrowRight, X } from "lucide-react";
...
const PreQualModal = ({ onClose, firstName, email }: { onClose: () => void; firstName: string; email: string }) => {
  ...
  const calendarSrc = `https://links.quietwealthengine.com/widget/booking/fA95vEUfzE9zbdjRnefn?first_name=${encodeURIComponent(firstName)}&email=${encodeURIComponent(email)}&diagnostic_prequal_questions=${encodedAnswers}`;
