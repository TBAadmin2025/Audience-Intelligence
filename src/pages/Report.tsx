...
import { ShieldCheck, Lock, Activity, TriangleAlert, TrendingUp, CheckCircle2, Sparkles, ArrowRight } from "lucide-react";
          ...
          <section className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="text-center space-y-6">
              <a
                ...
                className="inline-block bg-gradient-to-r from-gold-antique to-gold-metallic text-midnight px-20 py-8 rounded-sm text-xl font-bold uppercase tracking-[0.3em] transition-all duration-700 shadow-[0_30px_60px_rgba(170,124,17,0.3)] hover:scale-105 active:scale-95"
              >
